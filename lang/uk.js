export default {
    ...
    torent_nohash_do_four: 'Написати в Instagram: @online.cinematic',
    ...
    torrent_error_info_7: 'Якщо проблему не усунено, пишіть в Instagram @online.cinematic з текстом (Cinematic не підключається до TorrServer після всіх перевірок, поточна адреса {ip})',
    ...
    torrent_install_text: 'TorrServer – це програма, яка дозволяє переглядати контент із торент-файлів в онлайн режимі.',
    ...
    lampa_movie_descr: 'Кіно, про яке зараз говорять. <br>Instagram: <b>@online.cinematic</b>',
    ...
    https_text: 'Використовуйте протокол HTTPS, в цьому протоколі Cinematic працює некоректно. Для коректної роботи Cinematic використовуйте адресу з протоколом HTTP',
    ...
    termsofuse_t_01: "Правила використання",
    termsofuse_t_02: "Cinematic — це платформа, призначена для ознайомлення користувачів з актуальною інформацією кіноіндустрії, включаючи фільми, серіали, мультфільми та супутні дані. Джерелом інформації є відкритий ресурс — веб-сайт themoviedb.org.",
    termsofuse_t_03: "Контент та джерела",
    termsofuse_t_04: "Cinematic використовує API (Application Programming Interface) від каталогу themoviedb.org для отримання даних про фільми та телесеріали, а також для відображення пов'язаних медіафайлів, таких як постери, трейлери та інші матеріали.",
    termsofuse_t_05: "Доступ до бази даних: API від themoviedb.org надає додатку Cinematic доступ до бази даних фільмів та телесеріалів, забезпечуючи можливість пошуку медіафайлів та перегляду детальної інформації про них.",
    termsofuse_t_06: "Технічна взаємодія між додатком Cinematic та themoviedb.org здійснюється через запити до API, які надсилаються з клієнта на сервери themoviedb.org для отримання даних. Themoviedb.org обробляє запити та передає запитувані дані назад у додаток Cinematic.",
    termsofuse_t_07: "Таким чином, завдяки використанню API від themoviedb.org, додаток Cinematic надає користувачам доступ до великої бази даних контенту, дотримуючись при цьому умов використання та обмежень, встановлених правовласником.",
    termsofuse_t_08: "Розширення (Extensions)",
    termsofuse_t_09: "Розширення — це потужний інструментарій, доступний для додатку Cinematic, який дозволяє користувачам розширити його функціонал, додати додаткові можливості та адаптувати контент під свої індивідуальні потреби.",
    termsofuse_t_10: "Відмова від відповідальності: Користувачі встановлюють та використовують розширення виключно на свій страх і ризик. Усі наслідки, що виникають внаслідок використання сторонніх розширень, покладаються на користувача. Рекомендується ретельно оцінювати їх надійність та безпеку.",
    termsofuse_t_11: "Повідомлення про порушення авторських прав",
    termsofuse_t_12: "Якщо ви виявили ймовірне порушення авторських прав, просимо зв'язатися з розробниками через розділ «Контакти». Важливо враховувати, що додаток Cinematic використовує API від каталогу themoviedb.org, який надає відкритий доступ до загальнодоступної інформації про фільми та серіали, і, отже, не порушує авторських прав безпосередньо.",
    termsofuse_t_13: "Порядок усунення: Якщо ви вважаєте, що контент у Cinematic порушує права, зверніться до правовласника цього контенту з вимогою видалити його з сайту themoviedb.org. Додаток Cinematic видалить відображення контенту після отримання відповідного офіційного повідомлення про порушення авторських прав.",
    settings_rest_protocol_use: 'Безпечне з\'єднання',
    settings_rest_protocol_descr: 'Використати протокол HTTPS',
    install_app_apk_text: 'Ми помiтили, що для запуску Cinematic на Android ви використовуєте MediaStationX. Ми рекомендуємо вам встановити Lampa як APK-додатки. Ви можете завантажити останню версію програми тут:',
    ...
    loading_progress_step_0: 'Ініціалізація',
    loading_progress_step_1: 'Завантаження локалізації',
    loading_progress_step_2: 'Верифікація джерела',
    loading_progress_step_3: 'Завантаження розширень',
    loading_progress_step_4: 'Завершення',
    loading_progress_step_5: 'Система готова',

    install_extension_rule_1: 'Встановлення стороннього плагіна',
    install_extension_rule_2: 'Плагіни створюються незалежними розробниками, і Cinematic не перевіряє їхній вміст. Встановлюючи їх, ви погоджуєтеся з тим, що:',
    ...
    install_extension_rule_6: 'Cinematic не підтримує і не схвалює плагіни, пов’язані з піратським контентом.',
