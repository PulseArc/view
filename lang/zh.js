export default {
    ...
    torent_nohash_do_four: '在 Instagram 上留言: @online.cinematic',
    ...
    torrent_error_info_7: '如果问题仍未解决，请在 Instagram @online.cinematic 上留言，并附上文本（在所有检查后 Cinematic 无法连接到 TorrServer，当前地址 {ip}）',
    ...
    torrent_install_text: 'TorrServer 是一款允许您以在线模式观看 torrent 文件内容的应用程序。',
    ...
    https_text: '您使用的是 HTTPS 协议，在此协议下 Cinematic 无法正常工作。 为了 Cinematic 的正确操作，请使用具有 HTTP 协议的地址',
    ...
    termsofuse_t_02: "Cinematic 是一个旨在向用户介绍电影行业最新信息的平台，包括电影、电视剧、动画片和相关数据。信息来源是一个开放资源 — themoviedb.org 网站。",
    termsofuse_t_03: "内容与来源",
    termsofuse_t_04: "Cinematic 使用 themoviedb.org 目录的 API (应用程序编程接口) 来获取电影和电视剧的数据，并展示相关的媒体文件，如海报、预告片和其他材料。",
    termsofuse_t_05: "数据库访问：themoviedb.org 的 API 授予 Cinematic 应用程序访问电影和电视剧数据库的权限，提供搜索媒体文件和查看其详细信息的功能。",
    termsofuse_t_06: "Cinematic 应用程序与 themoviedb.org 之间的技术交互是通过 API 请求完成的，这些请求从客户端发送到 themoviedb.org 服务器以获取数据。Themoviedb.org 处理请求并将请求的数据传回 Cinematic 应用程序。",
    termsofuse_t_07: "因此，通过使用 themoviedb.org API，Cinematic 应用程序向用户提供了访问庞大内容数据库的权限，同时遵守了权利人设定的使用条款和限制。",
    termsofuse_t_08: "扩展 (Extensions)",
    termsofuse_t_09: "扩展是 Cinematic 应用程序可用的强大工具集，它允许用户扩展其功能、增加额外特性并根据其个性化需求调整内容。",
    termsofuse_t_10: "免责声明：用户安装和使用扩展完全自行承担风险。因使用第三方扩展而产生的所有后果均由用户承担。建议仔细评估它们的可靠性和安全性。",
    termsofuse_t_11: "版权侵权通知",
    termsofuse_t_12: "如果您发现涉嫌侵犯版权的行为，请通过“联系方式”部分与开发人员联系。请务必注意，Cinematic 应用程序使用的是 themoviedb.org 目录的 API，该 API 提供了对电影和电视剧公开信息的开放访问，因此不直接侵犯版权。",
    termsofuse_t_13: "补救程序：如果您认为 Cinematic 中的内容侵犯了您的权利，请联系该内容的权利人，要求将其从 themoviedb.org 网站上删除。Cinematic 应用程序将在收到相应的正式版权侵权通知后移除内容的展示。",
    settings_rest_protocol_use: '安全连接',
    settings_rest_protocol_descr: '使用HTTPS协议',
    install_app_apk_text: '我们注意到您正在使用 MediaStationX 在 Android 上运行 Cinematic。 我们建议您将 Lampa 安装为 APK 应用程序。 您可以在此处下载该应用程序的最新版本：',
    ...
    loading_progress_step_0: '初始化',
    loading_progress_step_1: '加载本地化',
    loading_progress_step_2: '来源验证',
    loading_progress_step_3: '加载扩展',
    loading_progress_step_4: '完成',
    loading_progress_step_5: '系统就绪',

    install_extension_rule_1: '安装第三方插件',
    install_extension_rule_2: '插件由独立开发者创建，Cinematic 不会审核其内容。安装插件即表示您同意以下内容：',
    ...
    install_extension_rule_6: 'Cinematic 不支持或认可与盗版内容相关的插件。',
