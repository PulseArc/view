...
termsofuse_t_01: "Правила за употреба",
termsofuse_t_02: "Cinematic е платформа, предназначена да запознава потребителите с актуална информация от филмовата индустрия, включително филми, сериали, анимационни филми и свързани данни. Източникът на информация е отворен ресурс — уебсайтът themoviedb.org.",
termsofuse_t_03: "Съдържание и източници",
termsofuse_t_04: "Cinematic използва API (Application Programming Interface) от каталога themoviedb.org за получаване на данни за филми и телевизионни сериали, както и за показване на свързани медийни файлове, като постери, трейлъри и други материали.",
termsofuse_t_05: "Достъп до базата данни: API от themoviedb.org предоставя на приложението Cinematic достъп до базата данни с филми и телевизионни сериали, осигурявайки възможност за търсене на медийни файлове и преглед на детайлна информация за тях.",
termsofuse_t_06: "Техническото взаимодействие между приложението Cinematic и themoviedb.org се осъществява чрез заявки към API, които се изпращат от клиента към сървърите на themoviedb.org за получаване на данни. Themoviedb.org обработва заявките и предава поисканите данни обратно към приложението Cinematic.",
termsofuse_t_07: "По този начин, благодарение на използването на API от themoviedb.org, приложението Cinematic предоставя на потребителите достъп до обширна база данни със съдържание, като същевременно спазва условията за ползване и ограниченията, установени от притежателя на авторските права.",
termsofuse_t_08: "Разширения (Extensions)",
termsofuse_t_09: "Разширенията са мощен инструментариум, достъпен за приложението Cinematic, който позволява на потребителите да разширят неговата функционалност, да добавят допълнителни възможности и да адаптират съдържанието към своите индивидуални нужди.",
termsofuse_t_10: "Отказ от отговорност: Потребителите инсталират и използват разширенията изцяло на свой собствен риск. Всички последици, произтичащи от използването на разширения от трети страни, се поемат от потребителя. Препоръчва се внимателно да се оценява тяхната надеждност и безопасност.",
termsofuse_t_11: "Уведомление за нарушения на авторски права",
termsofuse_t_12: "Ако откриете предполагаемо нарушение на авторски права, молим да се свържете с разработчиците чрез раздела «Контакти». Важно е да се отбележи, че приложението Cinematic използва API от каталога themoviedb.org, който предоставя отворен достъп до публично достъпна информация за филми и сериали, и следователно не нарушава пряко авторските права.",
termsofuse_t_13: "Процедура за отстраняване: Ако смятате, че съдържанието в Cinematic нарушава права, обърнете се към притежателя на авторските права на това съдържание с искане да го премахне от сайта themoviedb.org. Приложението Cinematic ще премахне показването на съдържанието след получаване на съответното официално уведомление за нарушение на авторски права.",

    settings_rest_protocol_use: 'Сигурна връзка',
    settings_rest_protocol_descr: 'Използвайте HTTPS протокол',
    install_app_apk_text: 'Забелязахме, че използвате MediaStationX, за да стартирате Cinematic на Android. Препоръчваме ви да инсталирате Lampa като APK приложение. Можете да изтеглите последната версия на приложението от тук:',
    ...
    loading_progress_step_1: 'Зареждане на локализацията',
    loading_progress_step_2: 'Верификация на източника',
    loading_progress_step_3: 'Зареждане на разширения',
    loading_progress_step_4: 'Завършване',
    loading_progress_step_5: 'Системата е готова',

    install_extension_rule_1: 'Инсталиране на външен плъгин',
    install_extension_rule_2: 'Плъгините са създадени от независими разработчици и Cinematic не проверява тяхното съдържание. С инсталирането им вие се съгласявате, че:',
    ...
    install_extension_rule_6: 'Cinematic не поддържа и не одобрява плъгини, свързани с пиратско съдържание.',
